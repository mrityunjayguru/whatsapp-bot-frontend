      ...
      menus: [
        {
          ...
          label: t("dashboard"),
          active: pathname.includes("/dashboard/analytics") || pathname.includes("/dashboard/dash-ecom") || pathname.includes("/dashboard/project") || pathname.includes("/dashboard/crm") || pathname.includes("/dashboard/banking"),
          icon: "heroicons-outline:home",
          submenus: [
            {
              href: "/dashboard/analytics",
